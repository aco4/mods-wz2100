...
{
	// always at least one oil drum, and one more for every 8x8 tiles of map area
	oilDrumData.maxOilDrums = (mapWidth * mapHeight) >> 6; // replace float division with shift for sync-safety
	for (let i = 0; i < oilDrumData.maxOilDrums; ++i)
	{
		queue("placeOilDrum", 1000 * i);
	}
}
