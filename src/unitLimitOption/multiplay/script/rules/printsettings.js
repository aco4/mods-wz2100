...
var human = {
	...
	unitLimit : function () {
		switch (scavengers) {
			case ULTIMATE_SCAVENGERS: return _("150 Unit Limit");
			case SCAVENGERS: return _("200 Unit Limit");
			case NO_SCAVENGERS: return _("250 Unit Limit");
			}
		},
...
//	debug([mapName, human.scavengers(), human.unitLimit(), human.alliancesType(), human.powerType(), human.baseType(), "T" + getMultiTechLevel(), version ].join("\n"));
	console([mapName, human.scavengers(), human.unitLimit(), human.alliancesType(), human.powerType(), human.baseType() ].join("\n"));
}
